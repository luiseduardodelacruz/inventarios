...
import com.example.inventarios.repository.ElasticoCinturaRepository;
import com.example.inventarios.repository.ElasticoPuñoRepository;
...
if (esValidoParaAjustador && !esTipoJogger) {
    ...
    for (String talla : tallas) {
        List<ElasticoPuño> elasticoPuñoList = elasticoPuñoRepository.findBySize(talla);
